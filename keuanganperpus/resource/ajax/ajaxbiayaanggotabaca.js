  ...
  $.ajax({ 
          url: getBaseURL()+"index.php/ctrbiayaanggotabaca/search/",
 ...
 $(document).ready(function(){ 
 $.ajax({ 
    url: getBaseURL()+"index.php/ctrbiayaanggotabaca/editrec/",
   data: "edidx="+edidx, 
  cache: false, 
 dataType: 'json', 
     type: 'POST', 
 ...
 $("#edbiaya").val(""); 
         ...
         $(document).ready(function(){
           ...
           $.ajax({ 
                 url: getBaseURL()+"index.php/ctrbiayaanggotabaca/simpan/",
   data: "edidx="+$("#edidx").val()+"&edidJenisTransaksi="+$("#edidJenisTransaksi").val()+"&edbiaya="+$("#edbiaya").val(), 
     ...
     { 
         $(document).ready(function(){ 
           $.ajax({ 
                 url: getBaseURL()+"index.php/ctrbiayaanggotabaca/deletetable/",
                 data: "edidx="+edidx, 
                 cache: false, 
                 dataType: 'json', 
                 type: 'POST', 
