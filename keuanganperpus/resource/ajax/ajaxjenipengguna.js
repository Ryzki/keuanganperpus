  ...
  $.ajax({ 
          url: getBaseURL()+"index.php/ctrjenipengguna/search/", 
 ...
 $(document).ready(function(){ 
 $.ajax({ 
    url: getBaseURL()+"index.php/ctrjenipengguna/editrec/", 
   data: "edidx="+edidx, 
  cache: false, 
 dataType: 'json', 
     type: 'POST', 
  success: function(json){ 
       $("#edidx").val(json.idx); 
       $("#edJenisPengguna").val(json.JenisPengguna); 
     }, 
 error: function (xmlHttpRequest, textStatus, errorThrown) { 
 start = xmlHttpRequest.responseText.search("<title>") + 7; 
     end = xmlHttpRequest.responseText.search("</title>"); 
 ...
 $("#edJenisPengguna").val(""); 
         ...
         $(document).ready(function(){ 
           $.ajax({ 
                 url: getBaseURL()+"index.php/ctrjenipengguna/simpan/", 
   data: "edidx="+$("#edidx").val()+"&edJenisPengguna="+$("#edJenisPengguna").val(), 
                 cache: false, 
                 dataType: 'json', 
                 type: 'POST', 
         ...
         function dohapus(edidx,edJenisPengguna){ 
         if (confirm("Anda yakin Akan menghapus data "+edJenisPengguna+"?")) 
     { 
         $(document).ready(function(){ 
           $.ajax({ 
                 url: getBaseURL()+"index.php/ctrjenipengguna/deletetable/", 
                 data: "edidx="+edidx, 
                 cache: false, 
                 dataType: 'json', 
                 type: 'POST', 
