  ...
  $.ajax({ 
          url: getBaseURL()+"index.php/ctrhargajenistransaksi/search/", 
 ...
 $(document).ready(function(){ 
 $.ajax({ 
    url: getBaseURL()+"index.php/ctrhargajenistransaksi/editrec/", 
   data: "edidx="+edidx, 
  cache: false, 
 dataType: 'json', 
     type: 'POST', 
 ...
 $("#edbiaya").val(""); 
         ...
         $(document).ready(function(){ 
           $.ajax({ 
                 url: getBaseURL()+"index.php/ctrhargajenistransaksi/simpan/", 
   data: "edidx="+$("#edidx").val()+"&edidJenisTransaksi="+$("#edidJenisTransaksi").val()+"&edbiaya="+$("#edbiaya").val(), 
                 cache: false, 
                 dataType: 'json', 
                 type: 'POST', 
         ...
         function dohapus(edidx,edidJenisTransaksi){ 
         if (confirm("Anda yakin Akan menghapus data "+edidJenisTransaksi+"?")) 
     { 
         $(document).ready(function(){ 
           $.ajax({ 
                 url: getBaseURL()+"index.php/ctrhargajenistransaksi/deletetable/", 
                 data: "edidx="+edidx, 
                 cache: false, 
                 dataType: 'json', 
                 type: 'POST', 
