...
class modelanggotabaca extends CI_Model {
    ...
    Function setInsertanggotabaca($xidx, $xNoIdentitas, $xNama, $xidJenisAnggota, $xAlamat, $xKota, $xkodepos, $xNotelp, $xemail, $xidjnsbiaya) {
        $xStr = " INSERT INTO anggotabaca( " .
                ...
                "kodepos," .
                "Notelp," .
                "email,idjnsbiaya) VALUES('" . $xidx . "','" . $xNoIdentitas . "','" . $xNama . "','" . $xidJenisAnggota . "','" . $xAlamat . "','" . $xKota . "','" . $xkodepos . "','" . $xNotelp . "','" . $xemail . "','" . $xidjnsbiaya . "')";
        $query = $this->db->query($xStr);
        return $xidx;
    }

    Function setUpdateanggotabaca($xidx, $xNoIdentitas, $xNama, $xidJenisAnggota, $xAlamat, $xKota, $xkodepos, $xNotelp, $xemail, $xidjnsbiaya) {
