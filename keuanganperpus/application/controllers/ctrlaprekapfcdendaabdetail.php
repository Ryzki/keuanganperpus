...
class ctrlaprekapfcdendaabdetail extends CI_Controller {
...
//  $this->load->view('test.php');
    ...
    function createform($xidx, $xAwal=0, $xSearch='') {
        ...
        $xForm = '<div id="stylized" class="myform"><h3>DETAIL PEMASUKKAN : FOTOKOPI,PRINT,DENDA, DAN ANGGOTA BACA </h3>' . form_open_multipart('ctranggotabaca/inserttable', array('id' => 'form', 'name' => 'form')) . '<div class="garis"></div>';
